...
from .views import visitante, finalizarSaida, controleChave, finalizarEntregaChave, controleVeiculo, finalizarSaidaVeiculo, relatorioAuditoria
...
urlpatterns = [
    ...
    path('relatorio/', relatorioAuditoria, name='relatorio')
]